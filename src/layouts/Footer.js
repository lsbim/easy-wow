    ...
    return (
        <div className={`w-full px-2 mt-auto`} style={{ height: `${FOOTER_HEIGHT}px` }}>
            <small className="block md:text-[12px] text-[10px]">
                Timeline data is retrieved from <a href="https://www.warcraftlogs.com" target="_blank" rel="noopener noreferrer" className="font-bold">Warcraft Logs. </a>
                Item and ability tooltips by <a href="https://www.wowhead.com" target="_blank" rel="noopener noreferrer" className="font-bold">Wowhead</a>.
                <br />
